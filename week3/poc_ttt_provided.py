...
def play_game(mc_move_function, ntrials, reverse = False):
    ...
    while winner == None:
        ...
        # returns 1, 1 with empty board
        # mc_move etc does not fill board.
        # yet returning row, col here fills board.
        #board is filled here, when it should only have one move in it
